...
module.exports = function listen(handler, ia32) {
    ...
    const MASK = {
        ...
        [MASK_FROM]:         0x000fff00,
        [MASK_TO]:           0xfff00000,
        [MASK_STACK_OFFSET]: 0x00000000  // unused
    }
    const MASK_OFFSET = {
        [MASK_STATE]: 0,
        [MASK_FROM]: 8,
        [MASK_TO]: 20,
        [MASK_STACK_OFFSET]: 32 // unused
    }
     ...
     * memory layout
     * ```
     * name   Thread index | GIL   | Buffer size | Data          |
     * value  int32        | int32 | int32       | user provided |
     * size   4            | 4     | 4           | All - other   |
     * ```
     */
