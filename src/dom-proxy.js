...
module.exports = {
    ...
    */   
    create: function create(ia32, getRoot) {
        ...
        */
        ...
        function listener(from, message) {
            ...
            return {
                success: false,
                error: convertToWrapped("not implemented method " + /** @type { any } */(message).type)
            }
        }
    ...
    __finalizationGroups: /** @type { FinalizationRegistry<any, any, number>[] } */([])
}